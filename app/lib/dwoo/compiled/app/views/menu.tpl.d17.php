<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><nav id="header-menu" class="unit three-quarters hide-on-phone">
...
<ul id="header-menu-ul" class="menu">
    <li class="menu-item current-menu-item current_page_item current-menu-ancestor current-menu-parent level-0">
        <a href="<?php echo $_SESSION['sys']['base_url'];?>" class="item no-icon">
    ...
    <li class="menu-item level-0 mega-menu">
        <a href="<?php echo $_SESSION['sys']['base_url'];?>Sobre" class="item no-icon">
            <span class="menu-item-content ib">
                <span class="menu-text">A Empresa</span>
            </span>
        </a>
    </li>
    <li class="menu-item level-0">
        <a href="<?php echo $_SESSION['sys']['base_url'];?>Servicos" class="item no-icon">
            <span class="menu-item-content ib">
    ...
    <li class="menu-item level-0">
        <a href="<?php echo $_SESSION['sys']['base_url'];?>Contato" class="item no-icon">
            <span class="menu-item-content ib">
