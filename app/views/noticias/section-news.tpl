<section class="unit three-quarters">
                ...
                {foreach $noticias noticia}
                      <article class="post with-thumbnail" data-appear-animation="fadeIn">
                        <div class="thumbnail">
                            <a href="{$dwoo.session.sys.base_url}Noticias/View/{$noticia.alias}"><img src="{$dwoo.session.sys.base_url}uploads/{$noticia.foto_chamada}" alt="{$noticia.titulo}" width="364" height="160" /></a>
