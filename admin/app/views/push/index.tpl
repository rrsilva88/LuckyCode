                    ...
                    <div class="control-group ">
                      ...
                      <div class="controls">
                        <textarea style="height:200px;" name='mensagem' rows="5" class="span12"></textarea>
                      </div>
                    </div>
                    <div class="alert alert-info">
                      <strong>Obs:</strong> Não é possivel enviar mensagens com mais de 1024 caracteres. 
                  </div>
...
function SendPush(){
  $(".loading").show();    
         ...
         $.post("Push/ajaxConfigPush", serial,
          function(data){
                 console.log(data);
