...
<div class="control-group">
    <label class="control-label">Título</label>
        <div class="controls">
          ...
          <input type="hidden"  value='{$noticia.id_artigo}'name='id_artigo'  class="span2">
  ...
  <div class="control-group">
    <label class="control-label">Tipo</label>
        <div class="controls">
          <select name='tipo'>
            <option value="Geral" {if $noticia.tipo == 'Geral'}SELECTED='SELECTED'{/if}>Geral</option>
            <option value="Nutrição" {if $noticia.tipo == 'Nutrição'}SELECTED='SELECTED'{/if}>Nutrição</option>
            <option value="Treino" {if $noticia.tipo == 'Treino'}SELECTED='SELECTED'{/if}>Treino</option>
          </select>
        </div>
  </div>
     ...
     $(".frm_motoboy").ajaxForm({
        ...
        success: function(data) {
            ...
            if(data.status == true){
                ...
                window.location.href = base_url+'Noticias/View/{$noticia.id_artigo}';
            }else{
