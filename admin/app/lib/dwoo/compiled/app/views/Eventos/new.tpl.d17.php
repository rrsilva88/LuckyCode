...
<div class="control-group">
    <label class="control-label">Título</label>
        <div class="controls">
          <input type="text" placeholder="Título" value='' name='titulo' class="span12">
        </div>
  </div>    
  ...
  <div class="control-group">
    <label class="control-label">Datas</label>
        <div class="controls">
           <input type="text" placeholder="Início" value='' name='data_ini' class="span2 date">
           <input type="text" placeholder="Termino" value='' name='data_fim' class="span2 date">
        </div>
  </div>
     ...
     $(".frm_motoboy").ajaxForm({
        ...
        success: function(data) {
            ...
            if(data.status == true){
                ...
                window.location.href = base_url+'Eventos/View/'+data.id;
            }else{
