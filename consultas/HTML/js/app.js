(function($) {
    ...
    var props = [{
        ...
        image : '1-1-thmb.png',
        type : 'Aberto',
        price : 'Consultorio Sorrident',
        address : 'Avenida Paulista,3889 - São paulo',
        bedrooms : '1234',
        bathrooms : '222',
        area : '123',
        position : {
    ...
    var addMarkers = function(props, map) {
        $.each(props, function(i,prop) {
            ...
            var infoboxContent = '<div class="infoW">' +
                                    '<div class="propImg">' +
                                        '<img src="images/medico/' + prop.image + '">' +
                                        '<div class="propBg">' +
                                    ...
                                    '<div class="infoButtons">' +
                                        ...
                                        '<a href="single.html" class="btn btn-sm btn-round btn-green viewInfo">Abrir</a>' +
                                    '</div>' +
                                 '</div>';
    ...
    setTimeout(function() {
        ...
        map.setCenter(new google.maps.LatLng(-23.5599713,-46.6673485));
        map.setZoom(14);
    ...
    $('.areaSlider').slider({
        ...
        slide: function(event, ui) {
            $('.areaSlider .sliderTooltip .stLabel').html(
                ui.values[0].toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + ' Metros' +
                ' <span class="fa fa-arrows-h"></span> ' +
                ui.values[1].toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + ' Metros'
            );
            var areaSliderRangeLeft = parseInt($('.areaSlider .ui-slider-range').css('left'));
            var areaSliderRangeWidth = $('.areaSlider .ui-slider-range').width();
            var areaSliderLeft = areaSliderRangeLeft + ( areaSliderRangeWidth / 2 ) - ( $('.areaSlider .sliderTooltip').width() / 2 );
    ...
    $('.areaSlider .sliderTooltip .stLabel').html(
        $('.areaSlider').slider('values', 0).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + ' Metros' +
        ' <span class="fa fa-arrows-h"></span> ' +
        $('.areaSlider').slider('values', 1).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + ' Metros'
    );
    var areaSliderRangeLeft = parseInt($('.areaSlider .ui-slider-range').css('left'));
    var areaSliderRangeWidth = $('.areaSlider .ui-slider-range').width();
    var areaSliderLeft = areaSliderRangeLeft + ( areaSliderRangeWidth / 2 ) - ( $('.areaSlider .sliderTooltip').width() / 2 );
