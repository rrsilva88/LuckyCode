<div class="col-md-12">
  <div class="grid solid red">
    ...
    <div class="grid-body">
      ...
      <a class="btn btn-primary" type="button" href="{$dwoo.session.sys.auth_link}"> <span class="pull-left"><i class="fa fa-instagram"></i></span> <span class="bold">&nbsp;&nbsp;Tentar novamente</span></a>
    </div>
  </div>
</div>