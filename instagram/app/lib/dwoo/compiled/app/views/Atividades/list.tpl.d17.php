...
?>
                  ...
                  <img src="<?php echo $this->scope["pic"]["images"]["standard_resolution"]["url"];?>" data-src="<?php echo $this->scope["pic"]["images"]["standard_resolution"]["url"];?>" data-src-retina="<?php echo $this->scope["pic"]["images"]["standard_resolution"]["url"];?>" alt="" class="image-responsive-width hover-effect-img"> 
                </div>
                </div>
<?php 
/* -- foreach end output */
