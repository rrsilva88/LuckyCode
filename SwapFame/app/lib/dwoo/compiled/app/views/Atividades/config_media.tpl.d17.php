                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="controls">
                                <h1 class="semi-bold" id='qtd_number'><?php echo $this->scope["limit_qtd"];?></h1>
                                  <input type="text" name='quantidade' id='sliderQTD'  class="slider-element form-control span12" data-slider-value="<?php echo $this->scope["limit_qtd"];?>" data-slider-step="1" data-slider-max="<?php echo $this->scope["limit_qtd"];?>" data-slider-orientation="horizontal" data-slider-selection="after" >
                                </div>
                              </div>
